...
SECRET_KEY = 'django-insecure-r%tf95ew79zgyy5231x(2*_96bwy&j@%o-(zabp65n%5m0!r4_'
...
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'django.contrib.auth.password_validation.UserAttributeSimiariltyValidator',
    },
    {
